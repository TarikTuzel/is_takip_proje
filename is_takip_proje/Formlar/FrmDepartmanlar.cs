...
namespace is_takip_proje.Formlar
{
    public partial class FrmDepartmanlar : Form
    {
        ...
        private void BtnEkle_Click(object sender, EventArgs e)
        {
            ...
            db.SaveChanges();
            XtraMessageBox.Show("Departman başarılı bir sekilde sisteme kaydedildi" ,
        ...
        private void BtnSil_Click(object sender, EventArgs e)
        {
            ...
            db.SaveChanges();
            XtraMessageBox.Show("Departman silme işlemi gerçekleşti.",
        ...
        private void BtnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            deger.Ad = TxtAd.Text;
            db.SaveChanges();
            XtraMessageBox.Show("Departman güncelleme işlemi gerçekleşti.",
